...
| [2.C] ```View by Year Only```| <img src="https://github.com/jschhie/expenseTracker/blob/master/updated_demos/view_by_year_only.png" width="350" height="350"> | In this case, view report for the year 2002 as a whole (Group by Transaction Type and Month). NOTE: Values displayed are approximate. |
