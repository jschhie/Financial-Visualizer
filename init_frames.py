...
def init_main(root):        
    ...
    Label(root.main_frame, text="Main Menu", font=('Arial', 20, 'bold')).grid(column=1, padx=20, pady=20)
...
def init_withdraw(root):
    ...
    back_button = Button(root.withdraw_frame, text="Return Home")
    back_button.bind("<Button-1>", root.return_to_main)
    back_button.grid(row=5, column=1, padx=5, pady=5)
...
def init_visualize(root):
    ...
    view_tags_button = Button(root.visualize_frame, text="Tags")
...
def init_history(root):
    ...
    show_summary_button = Button(root.history_frame,
    ...
    back_button = Button(root.history_frame, text="Return Home")
    back_button.bind("<Button-1>", root.return_to_main)
...
def init_summary(root):
    ...
    back_button = Button(root.summary_frame, text="Return Home")
    back_button.bind("<Button-1>", root.return_to_main)
    back_button.grid(row=13, column=1, padx=20, pady=20)        

    # Show More Button (in case > 10 records retrieved)
    show_more_button = Button(root.summary_frame, text="Show More Records")
